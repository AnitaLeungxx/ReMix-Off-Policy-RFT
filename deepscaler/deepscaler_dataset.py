...
if __name__ == '__main__':
    ...
    data_sources_test = ['aime', 'amc', 'math', 'minerva', 'olympiad_bench']
    ...
    for idx, example in enumerate(train_dataset):
        processed_example = process_fn(example, idx, 'train')
    ...
    for test_dataset, test_data_list in zip(test_datasets, test_datasets_data):
        ...
        for idx, example in enumerate(test_data_list):
            processed_example = process_fn(example, idx, data_sources_test[t_i])
            if processed_example is not None:
