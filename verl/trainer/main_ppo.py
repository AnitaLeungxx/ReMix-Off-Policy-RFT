...
def _select_rm_score_fn(data_source, rm_type):
...
class RewardManager():
    ...
    def __init__(self, tokenizer, num_examine, rm_type=None) -> None:
    ...
    def __call__(self, data: DataProto):
        ...
        def process_item(args):
            ...
            compute_score_fn = _select_rm_score_fn(data_source, self.rm_type)
...
def main_task(config):
    seed = int(os.getenv("SEED", "12354678"))
    ...
    reward_fn = RewardManager(tokenizer=tokenizer, num_examine=0, rm_type=config.trainer.rm_type)
